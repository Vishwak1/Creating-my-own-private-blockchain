...
class BlockchainController {
    ...
    //This endpoint allows you to check whether the chain is valid or not 
    validatechainEndPoint() {
        this.app.get("/validatechain", async (req, res) => {
            ...
            else return res.status(500).send("The chain is corrupt and has errors and the data has been tampered with");
